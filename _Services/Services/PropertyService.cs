    ...
    public class PropertyService : IPropertyService
    {
        ...
        public Property_AllInfo GetPropertyById(int Id)
        {
            try
            {
                ...
                if (property == null)
                {
                    throw new KeyNotFoundException("Property not found.");////very dangerus
                    return null;
                }
                                               ...
                                               bool HasBalcony = false, bool HasParking = false, bool HasCentralHeating = false, bool IsFurnished = false)
        {
            ...
            try
            {
                var properties = _unitOfWork.Property.GetPropertiesWithFilter(keyWord, city, status, null, maxPrice, null, maxArea, minBaths, null, minBed, null, HasGarage, Two_Stories, Laundry_Room, HasPool, HasGarden, HasElevator, HasBalcony, HasParking, HasCentralHeating, IsFurnished); return PropertyMapping.MapToPropertyList(properties);
            }
            catch (Exception ex)
            {
                // Log exception here
